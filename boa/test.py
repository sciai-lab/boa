    ...
    def __call__(self, batch):
        ...
        for x in batch:
            mol = build_molecule_np(
                charges=x.atom_types, positions=x.coords, basis=self.basis_info.basis_dict
            )
        ...
        for batch in test_loader:
            ...
            for i_pass in range(n_pass):
                ...
                pred = model.orbital_inference(
                    batch, coeffs, expo_scaling, n_probe, probe_coords, edge_index
                )
