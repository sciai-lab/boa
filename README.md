...
Debugging
```bash
python boa/train.py experiment=qm9_vasp_small_slurm hydra/launcher=submit_slurm_no_copy hydra.launcher.timeout_min=4 hydra.launcher.additional_parameters.signal="SIGUSR1@10" initial_guess_pre_training_steps=2 hydra.launcher.partition="gpu_a100_short" -m
```
